...
class BaseAPI {
  ...
  static String setActiveUserEndPoint =  '${BaseUrl.currentUrl}/api/user/is-active/';
  static String setAdminEndPoint =  '${BaseUrl.currentUrl}/api/user/is-admin/';
  static String updatePasswordUserEndPoint =  '${BaseUrl.currentUrl}/api/update-password';
