...
class AppColors {
  ...
  // ignore: non_constant_identifier_names
  static final MaterialColor PINK = _factoryColor(0xffFF4AA9);

  // ignore: non_constant_identifier_names
  static final MaterialColor LIGHT = _factoryColor(0xfff4f4f8);

  // ignore: non_constant_identifier_names
  static final MaterialColor LIGHT_GREY = _factoryColor(0xff3f3f3f);
  ...
  // ignore: non_constant_identifier_names
  static final MaterialColor BLUE = _factoryColor(0xFF3A5FFB);
